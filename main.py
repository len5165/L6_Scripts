...
class DataVisualizer(QMainWindow):
    ...
    def load_data(self):#Открывается диалоговое окно для выбора CSV-файла
    ...
    def update_stats(self):#Обновляет статистику данных
    ...
    def update_plot(self):#Обновляет график в зависимости от выбранного типа графика
        if self.data is not None:
    ...
    def add_data(self):#Добавляет новое значение в данные в зависимости от выбранного типа графика
